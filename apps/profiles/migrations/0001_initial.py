# Generated by Django 3.2.7 on 2022-12-13 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+917653387680', max_length=30, region=None, verbose_name='Phone Number')),
                ('about_me', models.TextField(default='say something about yourself', verbose_name='About Me')),
                ('license', models.CharField(blank=True, max_length=28, null=True, verbose_name='Real Estate License')),
                ('profile_photo', models.IntegerField(default='/profile_photo.png', verbose_name='Profile Photo')),
                ...
                ('city', models.CharField(default='Delhi', max_length=180, verbose_name='City')),
                ...
                ('top_agent', models.BooleanField(default=False, verbose_name='Top Agnet')),
