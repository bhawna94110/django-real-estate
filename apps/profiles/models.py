...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"), max_length = 30, default = "+917653387680")
    about_me = models.TextField(verbose_name=_("About Me"), default="say something about yourself")
    license = models.CharField(verbose_name=_("Real Estate License"), max_length=28, blank=True, null=True)
    profile_photo = models.ImageField(verbose_name=_("Profile Photo"), default="/profile_photo.png")
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Delhi", blank=False, null=False)
    ...
    top_agent = models.BooleanField(verbose_name=_("Top Agnet"), default=False)
